    ...
    maForm.addEventListener("submit", function (e) {
        ...
        for (let i = 0; i < devicesContainer.children.length; i++) {
          ...
          for (let i = 0; i < files.length; i++) {
            formData.append("formFiles", files[i]);
              ...
              formData.append("contactName", document.getElementById("full-name").value);
              ...
              formData.append("contactPosition", document.getElementById("position").value);
              formData.append("serviceType", document.getElementById("service-type").value);
              formData.append("model", document.getElementById(`model-${x}`).value);
              formData.append("serial", document.getElementById(`serial-number-${x}`).value);
              formData.append("forticloud", document.getElementById(`forticloud-${x}`).value);
              formData.append("maDuration", document.getElementById(`ma-duration-${x}`).value);
              formData.append("advanceReplacement", document.getElementById(`advance-replacement-${x}`).value);
              formData.append("sla", document.getElementById(`sla-${x}`).value);
              formData.append("additionalDetail", document.getElementById(`additional-details-${x}`).value);
   
              // Append formApp value
              formData.append("fromApp", "webpage");
  
              axios
              .post("http://nisolution.fortiddns.com:6334/sendMAFortigate", formData, {
                  headers: {
      ...
      if (
        ...
        for (let i = 0; i < devicesContainer.children.length; i++) {
          ...
          for (let i = 0; i < files.length; i++) {
            ...
            formData.append("serviceType", document.getElementById("service-type").value);
            formData.append("model", document.getElementById(`model-${x}`).value);
            formData.append("partNumber", document.getElementById(`part-number-${x}`).value);
            formData.append("serial", document.getElementById(`serial-number-${x}`).value);
            ...
            axios
            .post("http://nisolution.fortiddns.com:6334/sendMASiscoServer", formData, {
                headers: {
                "Content-Type": "multipart/form-data", // Important for file uploads
                },
            })
      ...
      if (document.getElementById("service-type").value === "Other") {
          ...
          for (let i = 0; i < files.length; i++) {
            ...
            formData.append("contactPosition", document.getElementById("position").value);
            formData.append("serviceType", document.getElementById("service-type").value);
            formData.append("additionalDetail", document.getElementById("other-details").value);
            ...
            axios
            .post("http://nisolution.fortiddns.com:6334/sendReqOther", formData, {
                headers: {
                "Content-Type": "multipart/form-data", // Important for file uploads
                },
            })
