...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const otherServicesSection = document.getElementById('other-services-section');
    ...
    function addDevice(serviceType) {
        ...
        if (serviceType !== 'Other') {
            const currentDropzone = deviceDiv.querySelector(`.dropzone#dropzone-${deviceIndex}`);
            const currentAttachmentsInput = deviceDiv.querySelector(`input[type="file"]#attachments-${deviceIndex}`);
            const currentFileList = deviceDiv.querySelector(`#file-list-${deviceIndex}`);
    ...
    function updateDevicesSection(serviceType) {
        ...
        if (serviceType === 'MA Fortigate' || serviceType === 'MA Cisco' || serviceType === 'MA Server') {
    ...
    serviceTypeSelect.addEventListener('change', function() {
        ...
        } else if (selectedService === "MA Fortigate" || selectedService === "MA Cisco" || selectedService === "MA Server") {
    ...
    addDeviceBtn.addEventListener('click', function() {
        ...
        if (selectedService === 'MA Fortigate' || selectedService === 'MA Cisco' || selectedService === 'MA Server') {
    ...
    maForm.addEventListener('submit', function(e) {
      ...
      if (document.getElementById('service-type').value === "Other"   ) {
        ...
        checkboxes.forEach((checkbox) => {
          ...
          desiredService : selectservice.join(', ')
      }
